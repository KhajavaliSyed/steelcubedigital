...
const service_details_content = {
    ...
    desctiption: <>At SteelCube Digital, we provide expert structural steel connection design services for fabricators and builders. 
               ...
               <div className="col-xl-6 col-lg-12">
                  <div className="tp-sv-details-serive-left wow tpfadeUp">
                     <div className="row">
                        ...
                        {
                            service_data.slice(24, 28).map((item, i)  => 
