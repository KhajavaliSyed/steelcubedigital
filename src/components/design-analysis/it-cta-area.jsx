...
const it_cta_content = {
    ...
    des: <>Experience the power of digital marketing with Steelcube Digital. 
    Let's embark on a journey to transform your business and achieve remarkable results together.</>
}
