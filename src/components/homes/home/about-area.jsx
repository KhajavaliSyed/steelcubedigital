...
const about_content = {
  ...
  des: (
    <>
      At Steelcube Digital, we are dedicated to illuminating your 
...
const { title, des, about_img1, about_img2, about_img3, sub_title } =
  ...
  // features data
const features = [
  { title: "Expert Team of Digital Marketing Professionals" },
  { title: "Data-Driven Approach for Optimal Results:" },
];
